...
def reproduce_audio(text):
    ...
    while pygame.mixer.music.get_busy():     
        continue
# programa princial de ejecucion del test
def mmain(Name,lang,VERSION,IP_port,vol,mode,robot):
    ...
    bg_image = pygame.image.load('media/fondo1.png')
    ...
    # Definir las variables a mostrar resultados
    ...
    def back():
        ...
        with open("media/ST_data.json", "w") as outfile:
            outfile.write(json_object)
        pygame.display.quit()
        with open("media/tmpp.txt", "w") as outfile:
