import pygame,time,json,datetime,statistics
...
def mmain(Name,lang,VERSION):
    ...
    # Cargar imágenes
    image1 = pygame.image.load("data/1.png")
    correct_image = pygame.image.load("data/2.png")
    incorrect_image = pygame.image.load("data/3.png")
        ...
        for event in pygame.event.get():
            ...
            # Verificar si se hizo clic en una imagen
                ...
                if ((correct_image_clicked ) or incorrect_image_clicked) and counter <=6:
                    ...
                    try:                  
                        image1 = pygame.image.load("data/{}.png".format(counter * 3 - 2))
                        correct_image = pygame.image.load("data/{}.png".format(counter * 3 - 1))
                        incorrect_image = pygame.image.load("data/{}.png".format(counter * 3))
